...
void Servo_Init(void){
  SysCtlPWMClockSet(SYSCTL_PWMDIV_1);  // sets the divider from the processor clock, so for 8962 20ns period
  ...
  PWMGenConfigure(PWM0_BASE, PWM_GEN_0, PWM_GEN_MODE_UP_DOWN | PWM_GEN_MODE_NO_SYNC);  // center centered pulses
	PWMGenPeriodSet(PWM0_BASE, PWM_GEN_0, 1000000); // 1000000 20ns ticks for 20ms servo period
