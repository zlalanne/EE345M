...
main(void)
{
    ...
    fresult = f_open(&g_sFileObject, "/test", FA_CREATE_NEW);
	fresult = f_open(&g_sFileObject, "/test", FA_WRITE);
	fresult = f_write(&g_sFileObject, test, sizeof(test), &usBytesWritten);
